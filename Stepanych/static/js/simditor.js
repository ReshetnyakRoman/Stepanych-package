...
Simditor.i18n = {
  'zh-CN': {
    ...
    'uploadError': 'Во время загрузки произошла ошибка',
    'imageUrl': 'URL картинки',
    'imageSize': 'Размер картинки',
    'imageAlt': 'Альтернативный текст',
    'restoreImageSize': 'Востановить начальный размер',
    'uploading': 'Загрузка',
    'indent': 'Отступ',
    ...
    'openLinkInCurrentWindow': 'В текущем окне',
    'openLinkInNewWindow': 'В новом окне',
    ...
    'alignment': 'Варавнивание',
    'alignCenter': 'По центу',
